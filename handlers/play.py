...
# play
@Client.on_message(command(["play", f"play@J_a_n_a_M_U_S_I_C_bot"]) & filters.group & ~filters.edited & ~filters.forwarded & ~filters.via_bot)
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"حدث خطأ ما\n{Exception}\n\nيرجي اعادة توجية هذة الرسالة الي المطور @SOURCESAKRAN\n\nقم بي اضافه الحساب المساعد يدويا @ALarakeyy")
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    except:
        await lel.edit(
            f"<b>هناك مشكلة لم استطيع دعوة الحساب المساعد ارسل الامر ( /userbotjoin ) حتا ينضم او قم بي اضافتة يدويا @ALarakeyy</b>"
        )
        return
    ...
    if audio:
        ...
        views = "@D_A_D_S_A_K_R_A_N_N"

        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟🇵🇸فمـبــيرـ͢", url=f"t.me/D_A_D_S_A_K_R_A_N_N"),
                    InlineKeyboardButton("𝐒𝐎𝐔𝐑𝐂𝐄🌀", url=f"t.me/SOURCESAKRAN"),
                ],
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("ᯓ˹ ??𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟🇵🇸فمـبــيرـ͢", url=f"t.me/D_A_D_S_A_K_R_A_N_N"),
                        InlineKeyboardButton("𝐒𝐎𝐔𝐑𝐂𝐄🌀", url=f"t.me/SOURCESAKRAN"),
                    ],
                    [InlineKeyboardButton(text="اغلاق القائمة", callback_data="cls")],
                ]
            ...
            title = "@D_A_D_S_A_K_R_A_N_N"
            thumb_name = "https://telegra.ph/file/cd0b87484429704c7b935.png"
            duration = "@XxlllllllllllllllllllllllllllxX"
            views = "@XxlllllllllllllllllllllllllllxX"
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟🇵🇸فمـبــيرـ͢", url=f"t.me/XxlllllllllllllllllllllllllllxX"),
