    ...
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        " 🧨 ¦ مطور السورس ", url="https://t.me/D_A_D_S_A_K_R_A_N_N"
                    )]
            ]
       ),
    )

@Client.on_message(command(["مبرمج السورس" ,"سكران" ,"سورس" ,"السورس" ,"حمو" ,"ميوزك زيزو" ,"زيزو"]) & filters.group & ~filters.edited)
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://graph.org/file/4160f8edd35ba843709a1.jpg",
        caption=f""" [ZelZal⚡️](t.me/E_1_R_1)  """,
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("سكران", url=f"https://t.me/D_A_D_S_A_K_R_A_N_N"),
           ],
            [ 
                InlineKeyboardButton("زلزال", url=f"https://t.me/E_1_R_1"),
            ],
            [
                InlineKeyboardButton(
                    "سورس ميوزك ", url=f"https://t.me/SOURCESAKRAN"
                ),
            ],
            [
                InlineKeyboardButton("☑️اضفني الى مجموعتك☑️", url=f"https://t.me/H_A_G_A_R_M_U_S_I_C_bot?startgroup=true"),
            ]
         ]
     )
  )
            ...
            return await m.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        url=f'https://t.me/J_a_n_a_M_U_S_I_C_bot?startgroup=true'),
                        ],
                    ]
                )
            )
