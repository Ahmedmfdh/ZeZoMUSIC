...
⌁ ⁞   Developed By [ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟🇵🇸فمـبــيرـ͢）⛧](https://t.me/D_A_D_S_A_K_R_A_N_N)!**
</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🔮ⓜⓤⓢⓘⓒ🔮", url="https://t.me/SOURCESAKRAN")
                  ],[
                  InlineKeyboardButton(
                        "ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟🇵🇸فمـبــيرـ͢）⛧", url="https://t.me/D_A_D_S_A_K_R_A_N_N")
                  ],[
                    InlineKeyboardButton(
                       "𝐒𝐎𝐔𝐑𝐂𝐄🌀", url="https://t.me/SOURCESAKRAN"
                    ),
                    InlineKeyboardButton(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "𝐒𝐎𝐔𝐑𝐂𝐄🌀", url=f"https://t.me/SOURCESAKRAN"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟🇵🇸فمـبــيرـ͢）⛧", url=f"https://t.me/D_A_D_S_A_K_R_A_N_N"
                    )
                ]
            ]
        )
